...
These templates are public-safe starting points for project memory and control files.

Use them to keep startup context small:

- `state.md` — current state pointer.
- `tasks.md` — current focus items.
- `guardrails.md` — durable safety checks.
- `session-note.md` — session summary format.
